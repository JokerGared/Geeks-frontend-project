...
const AddArticleForm = () => {
  ...
  const editingArticleFromStore = useSelector(selectCurrentArticle);
  const editingArticle = articleId ? editingArticleFromStore : null;
      ...
      {({ setFieldValue, errors, touched }) => (
        ...
        >
          <div className={css['create-article-form-img-title-wrapper']}>
            <div className="create-article-form-upload-with-button-wrapper">
          ...
          <div className={css['create-article-form-part']}>
            <Field
              ...
              className={`${css['create-article-form-input-text']} ${
                errors.article && touched.article ? css['input-error'] : ''
              }`}
          ...
          <div className={css.buttonGroup}>
            <button
              type="submit"
              className={
                editingArticle ? css.updateButton : css.fullWidthPublishButton
              }
            >
