...
const AddArticleForm = () => {
  ...
  const initialValues = { 
    ...
    img: null,
    publishDate: editingArticle?.publishDate ? new Date(editingArticle.publishDate) : new Date(),
      ...
      <Formik initialValues={initialValues} validationSchema={validationSchema} onSubmit={handleSubmit}>
        {({ setFieldValue }) => (
          <Form className={css["create-article-form-container"]} autoComplete="off">
            ...
            <button type="submit" className={css["publish-article-button"]}>{editingArticle ? 'Update Article' : 'Publish Article'}</button>
          </Form>)}
      </Formik>
    </>
  );
